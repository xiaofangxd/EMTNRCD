...
%% Load a dataset
flag = 1;  % set flag = 1 for synthetic networks or flag = 2 for real-world networks
% synthetic networks
...
%     global idealp weights neighbors;
    ...
    for timestep_num = 2 : num_timestep  
        [dynMod(timestep_num,r), dynPop{timestep_num,r}, DECS_Result{timestep_num,r}, ... 
            ...
            p_mutation, p_migration, p_mu_mi, num_neighbor, DECS_Result{timestep_num-1,r}, PGLP_iter, timestep_num);
