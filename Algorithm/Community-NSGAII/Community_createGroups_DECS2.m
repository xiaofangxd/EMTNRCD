function [EP,outIndexList, nmi] = Community_createGroups_DECS2(xPrime, Gfirst, i, labels)
...
% -----------------------------------------------------------------------
    ...
    num_neighbor = 5;    % the neighbor size for each subproblem
    ...
    [dynMod, dynPop, outIndexList, EP, dynTime] = DECS_2(varsafter, maxgen, pop_size, p_mutation, p_migration, p_mu_mi, num_neighbor, Gfirst, PGLP_iter, i);
