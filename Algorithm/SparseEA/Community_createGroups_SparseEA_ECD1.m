function [outIndexList,nmi] = Community_createGroups_SparseEA_ECD1(xPrime, labels)
...
% -----------------------------------------------------------------------
    ...
    p_migration = 0.20;   % the migration rate
    ...
    [dynMod, dynPop, outIndexList, dynTime] = ECD_1(varsafter, maxgen, pop_size, p_mutation, p_migration, p_mu_mi, Threshold);
