...
%--------------------------------------------------------------------------
    ...
    [~,FrontNo,CrowdDis] = Community_EnvironmentalSelectionNSGAII(Population,GlobalDummy.N);
    ...
    while currentEvaluations(GlobalDummy, isDummy) < maximum
        ...
        [Population,FrontNo,CrowdDis] = Community_EnvironmentalSelectionNSGAII([Population,Offspring],GlobalDummy.N);
    end
end
