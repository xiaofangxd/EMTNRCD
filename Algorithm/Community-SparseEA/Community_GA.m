function Offs = Community_GA(Parent,GlobalDummy,isDummy,Parameter)
...
%--------------------------------------------------------------------------
    ...
    if isa(Parent(1),'INDIVIDUAL')
        calObj = true;
        Parent = Parent.decs;
    elseif isa(Parent(1),'C_WeightIndividual')
        calObj = true;
        Parent = Parent.decs;
    else
        calObj = false;
    ...
    if calObj
        if isDummy == true
            ...
            Offs = [];
            for i = 1:L
                Offs = [Offs, C_WeightIndividual(Offspring(i,:),GlobalDummy)];
            end 
        else
            Offs = INDIVIDUAL(Offspring);
        end
    end
end